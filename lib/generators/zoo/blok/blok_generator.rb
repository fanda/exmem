...
module Zoo
  module Generators
    class BlokGenerator < Base
      ...
      class_option :skip_javascript, desc: 'Don\'t generate a javascript files.', type: :boolean
      ...
      def create_javascript
        unless @skip_javascript
          template 'model.coffee.erb', "app/assets/javascripts/models/#{model_path}.coffee.erb"
          #template "controls.coffee.erb", "app/assets/javascripts/controls/#{model_path.pluralize}.coffee.erb"
        end
      end
      ...
      def create_controller
        unless options.skip_controller?
          ...
          %w[box form index templates].each do |action|
            template "views/#{view_language}/_#{action}.html.#{view_language}", "app/views/#{plural_name}/_#{action}.html.#{view_language}"
          end
